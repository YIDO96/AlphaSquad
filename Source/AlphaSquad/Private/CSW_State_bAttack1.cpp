...
void UCSW_State_bAttack1::EnterState()
{
	...
	if (OwnerEnemy)
	{
		...
		if (enemy && enemy->Pattern_Montage_B1)
		{
			...
			if (AnimInstance)
			{
				AnimInstance->Montage_Play(enemy->Pattern_Montage_B1);
...
void UCSW_State_bAttack1::UpdateState()
{
	UE_LOG(LogTemp, Warning, TEXT("bAttack1 Update"));
}

void UCSW_State_bAttack1::ExitState()
{
	UE_LOG(LogTemp, Warning, TEXT("bAttack1 Exit"));
}
